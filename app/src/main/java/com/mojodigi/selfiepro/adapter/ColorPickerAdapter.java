...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
  ...
  public ColorPickerAdapter(@NonNull Context context) {
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.color_icon));
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.color_theme));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.colorAccent));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.hot_pink));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.deep_pink));
