...
public class FiltersThumbnailsAdapter extends RecyclerView.Adapter<FiltersThumbnailsAdapter.MyViewHolder> {
    ...
    public FiltersThumbnailsAdapter(Context context, List<ThumbnailItem> thumbnailItemList, ThumbnailsAdapterListener listener) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.filters_thumbnail_item, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            thumbnail = (ImageView) view.findViewById(R.id.filters_thumbnail);
            filterName = (TextView) view.findViewById(R.id.filters_name);
