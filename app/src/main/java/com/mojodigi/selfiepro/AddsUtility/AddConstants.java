...
public class AddConstants
{
    ...
    //  public static final String API_PUSH_NOTIFICATION = "http://development.bdigimedia.com/riccha_dev/Filehunt/pushNotifications/setFcmToken.php";
    ...
    public static final String VENDOR_ID="JMMSP001";
...
//    }
    ...
    public static JSONObject prepareAddJsonRequest(Context mContext, String valueVendorId, String versionName,int versionCode)
    {
        ...
        try {
            ...
            object.put(key_appName, mContext.getString(
                    R.string.app_name)+APP_NAME_POSTFIX);
