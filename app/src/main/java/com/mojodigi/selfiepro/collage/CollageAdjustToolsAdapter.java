...
import com.mojodigi.selfiepro.adjust.AdjustToolsModel;
...
public class CollageAdjustToolsAdapter extends RecyclerView.Adapter<CollageAdjustToolsAdapter.ViewHolder> {
    ...
    public CollageAdjustToolsAdapter(OnAdjustTollsSelected onGalleryAdjustTollsSelected) {
    ...
    @NonNull
    @Override
    public CollageAdjustToolsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_adjusttools, parent, false);

        return new CollageAdjustToolsAdapter.ViewHolder(view);
    }



    @Override
    public void onBindViewHolder(@NonNull final CollageAdjustToolsAdapter.ViewHolder holder, final int position) {
